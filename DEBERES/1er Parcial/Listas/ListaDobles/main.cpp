...
int main(){
        ...
        do{
                ...
                cout<<"!----------------------------------------------------------------|"<<endl;
                cout<<"| 1. Insertar dato por cabeza    | 4. Eliminar dato por cabeza   |"<<endl;//error al eliminar el unico elemnto de la lista
        ...
        /*lista.insertarPorInicio(50);
        lista.insertarPorInicio(20);
        lista.insertarPorInicio(60);//300 y 10
        lista.mcmmcdDeLista();*/
}
